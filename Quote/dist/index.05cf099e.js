...
var _startView = require("./views/StartView");
var _startViewDefault = parcelHelpers.interopDefault(_startView);
var _randomQuoteView = require("./views/RandomQuoteView");
...
parcelHelpers.export(exports, "imagesState", ()=>imagesState
);
...
const imagesState = async (url)=>{
    const images = await _helperModal.getJson(url);
    images.forEach((elem)=>{
        state.images.push(elem.urls.regular);
    });
};
const quoteState = async (url)=>{
...
},{}],"eYbc6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"eKMeO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parent = require("./Parent");
var _parentDefault = parcelHelpers.interopDefault(_parent);
class StartView extends _parentDefault.default {
    ...
    <div class="main__body-quote__data">
      <div class="main__body-quote__data-genre">${data[idx].genre.toUpperCase()}</div>
    ...
    setStartPage(images1, data1) {
        this.clearParent(this._quotes);
        const n = images1.length < data1.length ? images1.length : data1.length;
        for(let a = 0; a < n; a++){
            const html = this._getHtml(images1, data1, a);
            this._quotes.insertAdjacentHTML("afterbegin", html);
        }
    }
}
exports.default = new StartView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./Parent":"hi6Z1"}],"hi6Z1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Parent {
    ...
    clearParent(parentContainer1) {
        parentContainer1.innerHTML = "";
    }
}
exports.default = Parent;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"d13oS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parent = require("./Parent");
var _parentDefault = parcelHelpers.interopDefault(_parent);
class RandomQuoteView extends _parentDefault.default {
...
exports.default = new RandomQuoteView();

},{"./Parent":"hi6Z1","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2s4vs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parent = require("./Parent");
var _parentDefault = parcelHelpers.interopDefault(_parent);
class SearchView extends _parentDefault.default {
