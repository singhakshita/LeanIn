...
var _quoteView = require("./views/QuoteView");
var _quoteViewDefault = parcelHelpers.interopDefault(_quoteView);
var _modal = require("./modal");
async function setState() {
    await _modal.setQuote("https://quote-garden.herokuapp.com/api/v3/quotes");
    await _modal.setImage("https://api.unsplash.com/photos/?client_id=Zf7YB9W9lM19EQ0FPkGLrOFQyTJPPk1Z5BVZSgs6nK0");
    _quoteViewDefault.default.showData(_modal.state.images, _modal.state.quote);
}
const init = ()=>{
    setState();
};
init(); //https://quote-garden.herokuapp.com/api/v3/quotes?genre=age
 //https://quote-garden.herokuapp.com/api/v3/authors
 //https://quote-garden.herokuapp.com/api/v3/genres

},{"./views/QuoteView":"ksDas","./modal":"48dFD","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ksDas":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class QuoteView {
    ...
    <div class="main__body-quote__data">
            <div class="main__body-quote__data-genre">${quote[idx].genre.toUpperCase()}</div>
            <div class="main__body-quote__data-text">${quote[idx].text}</div>
            <div class="main__body-quote__data-author">${quote[idx].author}</div>
    </div>
  </div>`;
        return html;
    }
    showData(images1, quotes) {
        const n = images1.length < quotes.length ? images1.length : quotes.length;
        for(let a = 0; a < n; a++){
            const html = this._getHtml(images1, quotes, a);
            this._quotes.insertAdjacentHTML("afterbegin", html);
        }
    }
}
exports.default = new QuoteView();
...
},{}],"48dFD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "setQuote", ()=>setQuote
);
